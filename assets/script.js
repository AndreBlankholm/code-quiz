...
var highScoreFormContainer = document.getElementById(
  "final-score-form-container"
);
...
var viewHighScores = function () {
  ...
  for (var i = 0; i < sortedHighScores.length; i++) {
    var currentScore = sortedHighScores[i];
